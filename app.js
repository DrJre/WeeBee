...
const BW_NRT_CHARS = [
    ...
    {id:'jugo',       name:'Jugo',               img:'https://s4.anilist.co/file/anilistcdn/character/large/b71949-wcakVhS04k9t.png',   gender:'Male',   affiliation:['Missing-nin'],                           jutsuType:['Ninjutsu','Taijutsu'],                                                        nature:['Fire'],                                         kekkeiGenkai:true,  attribute:[],                    debutArc:'Tenchi Bridge Reconnaissance'},
