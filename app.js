...
const BW_NRT_CHARS = [
    ...
    {id:'jugo',       name:'Jugo',               img:'https://s4.anilist.co/file/anilistcdn/character/large/120371-M8sg6Ai5fLNS.jpg',   gender:'Male',   affiliation:['Missing-nin'],                           jutsuType:['Ninjutsu','Taijutsu'],                                                        nature:['Fire'],                                         kekkeiGenkai:true,  attribute:[],                    debutArc:'Tenchi Bridge Reconnaissance'},
